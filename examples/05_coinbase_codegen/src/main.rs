...
use fefix::{prelude, Dictionary, FieldMap, FieldType, GetConfig, SetField};
...
fn main() {
    ...
    //     encoder.start_message(b"FIXT.1.1", &mut buffer, &gdax::ApplVerId::Fix27.to_bytes());
    // msg.set(gdax::MSG_SEQ_NUM, 215);
    ...
    // msg.set(fix50sp2::NO_RELATED_SYM, 10);
